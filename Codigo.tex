...
\subsection{Código Bloque \textit{Divisor de frecuencia}:} \label{code:DivisorFrecuencia}
    ...
    \begin{figure}[H]
		    \centering
		    \includegraphics[width = 0.6\textwidth ]{BloqueDvisorFrecuenciaOK}
    ...
    \begin{figure}[H]
		    \centering
		    \includegraphics[width = 0.9\textwidth ]{BloqueDvisorFrecuenciaImplementacion}
...
\subsection{Código Bloque \textit{Divisor de frecuencia (testbench)}:} \label{code:DivisorFrecuencia_Tb}
    ...
    \begin{figure}[H]
		    \centering
		    \includegraphics[width = 0.8\textwidth ]{SimulacionDivisorFrecuencia}
...
\subsection {Código Bloque \textit{DecodificadoLED} :} \label{code:DecodificadorLED}
    ...
    \begin{figure}[H]
		    \centering
		    \includegraphics[width = 0.9\textwidth ]{DecodificadorLEDOKImplementacion}
