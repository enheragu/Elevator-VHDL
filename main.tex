...
\begin{document}
    ...
    \section{Introducción:} \label{section:Introduccion}
        \input{IntroObj} %importa el fichero IntroObj.tex con la introducción, objetivos y explicación general del proyecto
        
    \section{Diagrama de bloques:} \label{section:DiagBloques}
    
        \input{DiagramaBloques} %importa el fichero DiagramaBloques.tex
        
    \section{Código:} \label{section:Codigo}
    
        \input{Codigo} %importa el fichero Codigo.tex
        
    
    \input{Apendices} %importa el fichero Apendices.tex
